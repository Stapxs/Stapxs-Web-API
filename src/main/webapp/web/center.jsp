        ...
        <div class="ss-card" style="padding: 0;height: 200px;margin-bottom: 20px;">
            ...
            <div style="display: flex;padding-top: 40px;">
                ...
                <div id="login_info_pan" class="info-panel login-info" style="display: none;">
                    ...
                    <i id="login_time"></i>
                    <i id="login_ip"></i>
                    <button onclick="exitAcc()" class="ss-button"><i class="fa fa-sign-out" aria-hidden="true"></i> 退出登录</button>
                </div>
                <div id="exit_button_pan" class="info-panel login-info" style="min-width: 140px;margin-top: 15px;">
                    <button onclick="exitAcc()" class="ss-button center-exit" title="退出登录"><i class="fa fa-sign-out" aria-hidden="true"></i></button>
                </div>
            </div>
        </div>
        <div id="mail-check-body" class="ss-card" style="margin-bottom: 20px;display: none;">
            <header>
                <div></div>验证邮箱
                <form onsubmit="sendMail();return false;" class="key-control" style="float: right;display: flex;">
                    <button id="mail-button" type="submit" id="send-mail" class="ss-button" style="transition: width .3s;" title="发送验证码"><i class="fa fa-envelope" aria-hidden="true"></i> 发送验证码</button>
                    <input id="mail-input" type="email" class="ss-input" style="transition: width .3s;margin-right: 10px;width: 200px;" placeholder="绑定邮箱">
                </form>
            </header>
            <div class="ss-card" style="background: var(--color-card-1);padding: 20px;margin-top: 10px;">
                <span style="font-size: 0.8rem;">
                    验证邮箱功能用于防止恶意注册账户。在邮箱未完成验证之前，你将无法使用任何和账户相关的需要强验证的功能和接口。
                </span>
            </div>
            <div id="mail-check-inputs" style="display: none;">
                <label class="ss-code-input" id="mail-check-inputs-body">
                    <input type="text">
                    <input type="text">
                    <input type="text">
                    <input type="text">
